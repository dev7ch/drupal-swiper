  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['advanced']['coverflowEffect'] = [
      ...
      $form['grid']['sliderPerColumnFill'] = array(
          ...
          // Only integers.
          '#step' => 1,
          '#default_value' => $options['sliderPerColumnFill'] ?? $default_options['sliderPerColumnFill'],
      );
      $form['grid']['sliderPerGroup'] = array(
          ...
          // Only integers.
          '#step' => 1,
          '#default_value' => $options['sliderPerGroup'] ?? $default_options['sliderPerGroup'],
      );
      $form['grid']['centeredSlides'] = array(
          '#type' => 'checkbox',
          '#title' => $this->t('Slides centered'),
          '#default_value' => $options['centeredSlides'] ?? $default_options['centeredSlides'],
      );
